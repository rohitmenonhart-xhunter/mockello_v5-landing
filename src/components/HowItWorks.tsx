  ...
  const stepsData = [
    {
      ...
      description: "Create your account instantly. Ready to simplify your business? Get started with transparent, flat rates.",
      image: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "02",
      title: "Pick Your Workflows",
      description: "Choose your preferred workflows from our flexible modules. Each workflow built for productivity.",
      image: "https://images.unsplash.com/photo-1551650975-87deedd944c3?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Integrate Your Data",
      description: "Sync with leading tools for communications, payments, and more. Developer-friendly APIs included.",
      image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Automate, Learn, Grow",
      description: "Let AI tackle your busy-work while you focus on innovation. Platform updates delivered monthly.",
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How Mockello Transforms Your Business</h2>
          <p className="section-subtitle mx-auto">
            A seamless four-step process from signup to full business transformation.
          </p>
        </div>
